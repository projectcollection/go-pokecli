...
type PokemonEncounters struct {
	...
	VersionDetails []PokemonDetails `json:"version_details"`
}

func Explore(loc string)  ([]PokemonEncounters, error) {
    api := fmt.Sprintf(site, loc)

    data, err := getData[ExploreData](api+"-area")
